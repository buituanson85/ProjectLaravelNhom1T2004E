...
function factory(classie) {
	...
	/**
	 * Set the z-index of the currently open select higher than any others on the pages.
	 * WIthout this, if you have multiple copies of a select box, examples further down
	 * the pages will stay on top of the options of selects further up the pages.
	 */
