...
(function( $, window, document, undefined ) {
	...
	/**
	 * Provide backwards compatibility for the js DT options. Note that the new
	...
	function _fnCalculateColumnWidths ( oSettings )
	{
		...
		else
		{
			...
			// table widths
			var tmpTable = $(table).clone() // don't use cloneNode - IE8 will remove events on the js table
	...
	DataTable.models.oSettings = {
		...
		/**
		 * The TABLE node for the js table
		 *  @type node
		 *  @default null
		 */
		"nTable": null,
	...
	DataTable.ext = _ext = {
		 ...
		 *   (false)
		 *
		 * Note that as with the js search ability in DataTables, technically this
