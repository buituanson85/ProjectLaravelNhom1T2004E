                ...
                <div class="col-md-10 offset-md-1">
                    <div class="card card-primary">
                        ...
                        <div class="card-footer form-inline">
                            <form action="{{ route('dashboards.updateconfirmorders', $order_id) }}" method="post">
                                @csrf
                                <button type="submit"  style="margin: 5px" class="btn btn-primary"><i class="fas fa-save"></i> Quay lại</button>
                            </form>
                        </div>
                    </div>
                </div>
