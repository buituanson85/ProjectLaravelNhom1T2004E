            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title" style="margin-top: 10px">
                        ...
                        <span style="float: left"><a href="{{ URL::to('/dashboards/products') }}">Danh sách phương tiện</a></span>
                    </div>
                </div>
            </div>
        </div>
...
{{--                                        <td>{{ $product->district->name }}</td>--}}
                                        <td><a href="{{route('product.show', $product->id)}}"><span class="btn btn-sm btn-light"><i class="fa fa-eye"></i>&nbsp;Chi tiết</span></a></td>
                                        <td>
