                    ...
                    <div class="p-0">
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h3 class="card-title" style="font-size: 20px;font-weight: 700">Danh sách phương tiện(Có thể nhận chuyến)</h3>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <table class="table table-hover text-nowrap" id="product_table" >
                                    ...
                                    @foreach($products as $product)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('dashboards.editphuongtien', $product->id ) }}"><span class="btn btn-sm btn-warning"><i class="fa fa-edit"></i>&nbsp;Cập nhật</span></a>
                                            </td>
                                            <td>
