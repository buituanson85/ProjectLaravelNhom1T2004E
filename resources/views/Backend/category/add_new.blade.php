            ...
            <div class="col-md-10">
                <div class="page-header float-left">
                    <div class="page-title" style="margin-top: 10px">
                        ...
                        <span style="float: left;margin: 0 5px">/</span>
                        <span style="float: left"><a href="{{ route('cate.create') }}">Thêm Loại Danh Mục</a></span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-8 offset-md-2">
                    <div class="card card-primary">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3 class="card-title">Thêm loại danh mục</h3>
                                </div>
                                <div class="col-md-6">
                        ...
                        <form method="post" action="{{route('cate.store')}}">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" onkeyup="ChangeToSlug()"  id="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="Category Name">
                                    @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="slug"  id="slug" class="form-control @error('slug') is-invalid @enderror" value="{{ old('slug') }}" placeholder="Category Slug">
                                    @error('slug')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group">
                                    <label for="status">Trạng thái loại danh mục</label>
