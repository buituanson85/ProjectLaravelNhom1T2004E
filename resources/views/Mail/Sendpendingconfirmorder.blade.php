        ...
        <tr>
            <td>
                <table align="center" style="width:100%;max-width:670px;background:#ffffff;padding-top:40px;padding-left:40px;padding-right:40px;padding-bottom:40px">
                    <tbody>
                    <tr>
                        <td style="color:#0a73b7;font-family:Arial,sans-serif;font-size:24px;text-align:center;font-weight:bold">Quá thời gian xác nhận chuyến</td>
                    </tr>
                    <tr><td style="padding-bottom:30px;color:#f7a51c;font-family:Arial,sans-serif;font-size:18px;text-align:center;font-weight:bold;font-style:italic"></td>
                        ...
                        <td style="padding:0 10px 20px 10px;color:#373636;font-family:Arial,sans-serif;font-size:16px;line-height:20px"><p>Xin chào {{ $orders['name'] }}!</p><p>Bạn đã vi phạm quy định về thời gian nhận chuyến,chúng tôi sẽ tạm thời khóa phương tiện này. Bạn vui lòng kiểm tra lại tài khoản và liện hệ theo số điện thoại 1900 636585 để biết thêm chi tiết và mở khóa phương tiện!
                            </p>
                            <p style="color: red;font-size: 12px">{{ $orders['date'] }}</p>
                            <ul>
                                <li>Mã chuyến xe: <b>{{ $orders['order'] }}</b></li>
                                <li>Thời gian nhận chuyến: <b>{{ $orders['order_time'] }}</a></b></li>
                                <li>Phương tiện: <b>{{ $orders['product_name'] }}</b></li>
                            </ul>
