        ...
        <tr>
            <td>
                <table align="center" style="width:100%;max-width:670px;background:#ffffff;padding-top:40px;padding-left:40px;padding-right:40px;padding-bottom:40px">
                    <tbody>
                    <tr>
                        <td style="color:#0a73b7;font-family:Arial,sans-serif;font-size:24px;text-align:center;font-weight:bold">THÔNG TIN ĐĂNG KÍ ĐỐI TÁC</td>
                    </tr>
                    <tr><td style="padding-bottom:30px;color:#f7a51c;font-family:Arial,sans-serif;font-size:18px;text-align:center;font-weight:bold;font-style:italic"></td>
                        ...
                        <td style="padding:0 10px 20px 10px;color:#373636;font-family:Arial,sans-serif;font-size:16px;line-height:20px"><p>Xin chào {{ $partners['name'] }}!</p><p>Thông tin đăng kí đối tác của bạn đã được ghi nhận. Chúng tôi sẽ liên hệ lại với bạn qua số điện thoại trong thời gian sớm nhất!
                                <br><br>THÔNG TIN ĐĂNG KÍ ĐỐI TÁC.
                            </p>
                            <p style="color: red;font-size: 16px">{{ $partners['date'] }}</p>
                            <ul>
                                <li>Tên chủ xe: <b>{{ $partners['name'] }}</b></li>
                                <li>Email: <b><a href="mailto:{{ $partners['email'] }}">{{ $partners['email'] }}</a></b></li>
                                <li>Số điện thoại: <b>{{ $partners['phone'] }}</b></li>
                                <li>Địa chỉ: <b>{{ $partners['address'] }}</b></li>
                                <li>Tiêu đề: <b>{{ $partners['title'] }}</b></li>
                                <li>Nội dung: <b>{{ $partners['note'] }}</b></li>
                            </ul>
