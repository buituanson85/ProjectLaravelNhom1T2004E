        ...
        <div class="info">
            <div class="info_left">
                <div class="info_left_detail">
                    ...
                    <span style="display: flex; justify-content: space-between">
                        <p>Bảo hiểm xe</p>
                        <p style="font-weight: 700">{{$product->insurrance}} đ</p>
                    </span>
                    
                    <hr>
                    <span style="display: flex; justify-content: space-between">
                        <h5 style="text-transform: uppercase;color: teal" >Tổng</h5>
                        <h5 style="font-weight: 700;color: teal">{{$total_price}} Đ</h5>
                    </span>

                </div>

            </div>
            <div class="info-right pt-5">
                           ...
                           <form action="{{route('order.store')}}" method="post">
                            @csrf
                               ...
                               <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" 
                                    id="inputemail" name="inputemail" disabled="disabled" value="{{Auth::user()->email}}" placeholder="Nhập email">
                                </div>
                            </div>
                               <div class="form-group row">
                                   ...
                                   <div class="col-sm-9">
                                       <input type="text" 
                                       class="form-control" name="inputphone" id="inputphone" placeholder="Nhập số điện thoại">
                                   </div>
                               </div>
                               ...
                               <div class="form-group row">
                                   ...
                                   <div class="col-sm-9">
                                       ...
                                       <textarea class="form-control" placeholder="Nhập ghi chú" name="inputnote" 
